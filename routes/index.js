...
module.exports = function ({ app, dbConn }) {
  ...
  app.get('/fagperson/patient/:patient', function(req, res) { fagperson.patient(req, res, dbConn) });
  app.post('/fagperson/note/', function(req, res) { fagperson.note(req, res, dbConn) });
